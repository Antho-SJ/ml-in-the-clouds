# Projet La plateforme - ml-in-the-clouds

Projet sur l'autoML réalisé par :
...
Développement d'un outil visant permettant de reconnaître les émotions se cachant derrière des posts de réseaux sociaux.
